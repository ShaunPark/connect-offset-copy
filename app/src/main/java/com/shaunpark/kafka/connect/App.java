...
public class App {
    ...
    public Hashtable<String, String> loadOffsets(Properties props, Map<TopicPartition, Long> offsetMap) {
        ...
        // while(ii.hasNext()) {
        //     String key = ii.next();
        //     String value = offsets.get(key);
        //     String[] strs = keyToNames(key);
        //     logger.info("Key:Value = " + key + ":" + strs[0] + ":" + strs[1] );
        // }
    }

    ObjectMapper mapper =  new ObjectMapper();

    // private String[] keyToNames(String key) {        
    //     try {
    //         Object[] objs = mapper.readValue(key, Object[].class);
    //         if( objs.length == 2 ) {
    //             LinkedHashMap<String,String> hmap = (LinkedHashMap)objs[1];
    //             if( hmap != null ) {
    //                 String serverName = (String)hmap.get("server");
    //                 String[] ret = {(String)objs[0], serverName};
    //                 return ret;
    //             }
